...
public class Beam03_MeetGreenSpin extends Tray {

    private static final float BEAM_ANGULAR_VELOCITY = 0.1f;
    // The game objects
    private BallOnSpring white, green;
    private Rock rock;
    private Beam beam;

    public Beam03_MeetGreenSpin(Start game) {
        super(game);
        buildScene();
    }
    ...
    private void buildScene() {
        ...
        green = new BallOnSpring(world, new Vector2(-BEAM_LENGTH / 2f, 0f), GREEN_RADIUS, Color.GREEN);
    ...
    void instructions(int yPos) {
        spriteBatch.begin();
        font.draw(spriteBatch, "As before but with a TWIST.", 200, yPos);
        spriteBatch.end();
    }
