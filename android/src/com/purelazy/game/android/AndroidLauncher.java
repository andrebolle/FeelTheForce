...
//    }
    ...
    //Debug.startMethodTracing("graphics_profiling"); // Andre
  ...
  private View createGameView(AndroidApplicationConfiguration cfg) {
		...
		gameView = initializeForView(new Start(), cfg);
  ...
  private void startAdvertising(AdView adView) {
    ...
    .addTestDevice("8BA57E7453D6A9708911FB1793D29651")
    .build();
